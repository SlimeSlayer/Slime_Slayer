...
public:
	...
	// Draw & Blit ----------
	bool Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section = NULL,bool use_camera = false, bool horizontal_flip = false, float scale = 1.0f, uint opacity = 255, int pivot_x = 0, int pivot_y = 0, float speed = 1.0f, double angle = 0) const;
